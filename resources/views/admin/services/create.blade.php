            ...
            <div class="admin-card">
                ...
                <div class="admin-card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="admin-form-hint">URL-friendly identifier, e.g. <code>refrigerator-repair</code></div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="excerpt" name="excerpt" class="form-control @error('excerpt') is-invalid @enderror"
                               value="{{ old('excerpt') }}" maxlength="500">
                        <div class="admin-form-hint">Short description shown on cards and the home page slider</div>
            ...
            <div class="admin-card">
                ...
                <div class="admin-card-body">
                    ...
                    <button type="submit" class="admin-btn admin-btn-primary" style="width:100%;">
                        <i class="fa-solid fa-floppy-disk"></i> Create Service
                    </button>
                </div>
            </div>
        </div>
