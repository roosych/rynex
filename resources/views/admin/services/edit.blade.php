    ...
    <div class="row">
                ...
                <div class="admin-card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="meta_title" name="meta_title"
                               ...
                               placeholder="Оставь пустым — будет: {{ $service->title }} in Chicago, IL | {{ $generalSettings->company_name }}">
                    ...
                    @include('admin.partials.seo-preview', [
                        ...
                        'serpFallbackTitle'=> $service->title . ' in Chicago, IL | ' . $generalSettings->company_name,
                        'serpFallbackDesc' => 'Professional ' . $service->title . ' in Chicago, IL.',
                    ])
        ...
        <div class="col-lg-4">
            ...
            <div class="admin-card" style="border:1px solid #fee2e2;">
                <div class="admin-card-body">
                    <button type="submit" form="service-delete-form" class="admin-btn admin-btn-danger" style="width:100%;">
...
<form id="service-delete-form" method="POST" action="{{ route('admin.services.destroy', $service) }}"
