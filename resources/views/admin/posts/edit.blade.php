    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="admin-card" style="border:1px solid #fee2e2;">
                <div class="admin-card-body">
                    <button type="submit" form="post-delete-form" class="admin-btn admin-btn-danger" style="width:100%;">
...
<form id="post-delete-form" method="POST" action="{{ route('admin.posts.destroy', $post) }}"
