...
class SeoSettings extends Settings
{
    ...
    public string $about_description = 'Learn about RynexFix Appliance Repair — your trusted local appliance repair experts since 2012. Certified technicians, 90-day warranty, serving Chicago, IL.';

    // Services index
    public string $services_title       = 'Appliance Repair Services in Chicago, IL | RynexFix';
    public string $services_description = 'RynexFix offers refrigerator, washer, dryer, dishwasher, oven, and AC repair in Chicago, IL. Same-day service, upfront pricing, 90-day warranty.';
    ...
    public string $booking_description = 'Book a same-day appliance repair with RynexFix in Chicago, IL. Fill out the form and we\'ll confirm your appointment fast. Certified technicians, 90-day warranty.';
